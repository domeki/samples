 ...
 * @author tgiunipero
 */
@WebServlet(name="TestOrderManager", urlPatterns={"/TestOrderManager"})
public class TestOrderManager extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("TEST: OrderManager...");
        ...
        orderManager.placeOrder("Fiona Wilson",
                "f.wilson@seznam.cz",
                "606252924",
                "Dlouhá 34",
                "1",
